export class Pagination {
  ...
  update({currentPage, totalPages, totalProducts, limit}){
    ...
    this.paginationBar.style = `--width: calc(${
      currentPage === totalPages
        ? totalProducts
        : currentPage * limit
    }/${totalProducts} * 100%)`;

    this.paginationCurrent.textContent = currentPage === totalPages
    ? totalProducts
    : currentPage * limit;
  ...
  createPagination() {
    ...
    paginationElem.append(this.paginationBar, paginationArrays);
