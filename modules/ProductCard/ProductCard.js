...
import {CardButton} from '../../features/CartButton/CardButton';
...
export class ProductCard {
  ...
  render(data) {
    ...
    productArticle.innerHTML = `${data.article}`;
    ...
    tableCharacteristics.classList.add(
      'table',
    ...
    const productBtn = new CardButton('product__btn', 'В корзину').create(
      data.id
    );
